            ...
            return (
                <div className="w-full cursor-pointer py-1">
                    <div className="flex flex-wrap gap-2">
                        {text.split(' ').slice(0, 8).map((word, i) => (
                            <div
                                key={i}
                                className="h-4 bg-white/5 rounded transition-colors"
                                style={{ width: `${(word.length * 8) + 20}px`, maxWidth: '100px' }}
                            ></div>
                        ))}
                    </div>
                    <span className="text-[10px] uppercase tracking-widest text-cube-text-muted mt-3 block opacity-40 group-hover:opacity-100 transition-opacity">
                        Tap to reveal
                    </span>
                </div>
            )
                ...
                {lines.map((line) => {
                    ...
                    return (
                        <div
                            ...
                            className={`group transition-all duration-300 rounded-2xl p-5 border border-transparent cursor-pointer ${isActive
                        ...
                        >
                            <div className="flex items-start gap-4">
                                ...
                                <div className={`mt-1 flex flex-col items-center min-w-[3rem]`}>
                                    <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold font-display uppercase transition-colors ${isActive
